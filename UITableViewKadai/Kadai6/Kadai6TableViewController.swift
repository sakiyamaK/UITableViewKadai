...
class Kadai6TableViewController: UIViewController {
...
extension Kadai6TableViewController: UITableViewDataSource {
...
extension Kadai6TableViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let vc = DetailViewController()
        vc.configure(indexPath: indexPath)
